...
from windows.Panel_Serial      import SerialPanel
from windows.Panel_Ensayo      import PanelEnsayo
from windows.Panel_Parametros  import PanelParametros
from windows.Panel_Histograma  import PanelHistograma

from core.ensayo_sesion          import EnsayoSession, TARMode
from core.Fuentes.fuente_serie   import SerialSource
from core.Fuentes.fuente_replay    import ReplayFuente
...
Versión: 1.0.0 | 2026
    ...
    def iniciar_ensayo(self, duracion_seg):
        ...
        self.ensayo.set_error_callback(self._on_error_hardware)
    ...
    def _tick_ensayo(self):
        ...
        """
        # Saltar si estamos en replay bloqueante
    ...
    def _on_error_hardware(self, msg: str):
        messagebox.showerror("Error de hardware", msg)
        self._on_ensayo_finalizado()
