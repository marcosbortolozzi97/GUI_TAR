...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.title("TAR GUI")
        self.state('zoomed')    # Ventana maximizada al abrir
    ...
    def _construir_ui(self):
        ...
        self.btn_ayuda = tk.Button(
            frame_der, text="?", font=("Segoe UI Symbol", 15, "bold"),
    ...
    def _popup_configuracion(self, conf: dict):
        ...
        ttk.Label(main, text=txt, justify="left", font=("Arial", 10)).pack(anchor="w")
...
BIN (bin/):
  ...
  - test-config.txt: Configuración de umbrales aplicada
        ...
        ttk.Label(
            scrollable_frame,
            text="Sistema Digitalizador - Reactor RA-4",
            font=("Arial", 9, "italic"),
            foreground="gray"
        ).pack(pady=(0, 5))
        ...
        # Bind del scroll en Windows/Linux
        canvas.bind_all("<MouseWheel>", _on_mousewheel)
        
        # Limpiar el binding cuando se cierra la ventana
        def _on_closing():
    ...
    def _mostrar_acerca_de(self):
        ...
        texto_intro = (
            "TAR:\n"
            "El TAR es un dispositivo diseñado para la digitalización de pulsos en cadenas de mediciones nucleares, reemplazando a los módulos\n"
            "de conteo de pulsos tradicionales. Para cada pulsodetectado, se registra su amplitud y su instante de ocurrencia (timestamp).\n" 
            "Esta digitalizaciónde la información en bruto, que es transferida a una PC, permite mayor flexibilidad y un mejor procesamiento\n" 
            ...
            "INTERFAZ (GUI):\n"
            "El presente software provee una interfaz con el TAR para facilitar la toma de datos, almacenandolos datos en la PC en archivos .csv\n" 
            "y .bin, para su posterior procesamiento por parte del usuario, de acuerdo al ensayo que desee realizar. También permite la\n" 
            "visualización en tiempo real de los espectros obtenidos y la reproducción de ensayos realizados anteriormente."
        )
