...
class PanelParametros(ttk.LabelFrame):
    ...
    def __init__(self, parent, on_apply_params_callback=None):
        ...
        # -------------------------------------------------
        self.status = ttk.Label(self, text="", font=("Arial", 8), foreground="green")
        ...
        # Umbrales Canal A
        # ----------------------------------
        ttk.Label(self, text="Umbral CHA:", font=("Arial", 9, "bold")).grid(
        ...
        self.var_cha_min = tk.StringVar(value="311")
        self.var_cha_max = tk.StringVar(value="914")
        ...
        self.lbl_cha_min_mv = ttk.Label(self, text="cuentas ADC (998.3 mV)", 
                                         foreground="#3D3D3D")
        self.lbl_cha_max_mv = ttk.Label(self, text="cuentas ADC (2933.9 mV)", 
                                         foreground="#3D3D3D")
        ...
        # Umbrales Canal B 
        # ----------------------------------
        ttk.Label(self, text="Umbral CHB:", font=("Arial", 9, "bold")).grid(
        ...
        self.var_chb_min = tk.StringVar(value="311")
        self.var_chb_max = tk.StringVar(value="914")
        ...
        # Labels dinámicos con conversión a mV
        self.lbl_chb_min_mv = ttk.Label(self, text="cuentas ADC (998.3 mV)", 
                                         foreground="#3D3D3D")
        self.lbl_chb_max_mv = ttk.Label(self, text="cuentas ADC (2933.9 mV)", 
                                         foreground="#3D3D3D")
